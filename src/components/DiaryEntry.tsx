    ...
    <div className="flex flex-col gap-6 text-[#3b2a1a] font-serif leading-relaxed text-sm sm:text-base">
      ...
      {lang === 'es' && (
        <div className="space-y-4 pt-2">
          ...
          <p className="italic font-bold">P.S. Los quiero mucho visitantes y siempre estare aca armando una experiencia registrando cada cosita que descubro, no quiero dejar morir las cosas buenas que se cruzan con uno :)</p>
        </div>
      )}
